package com.dimas.study_project_kt
...
class MainActivity : AppCompatActivity() {
    ...
    private fun check() {
        ...
        //Создаем переменную randChoice и присваеваем ей Рандом сласс
        val randChoice = Random().nextInt(20)+1
        val imgRes = when (randChoice) {
